...
<body>
	...
	<c:if test="${timesheet.size() gt 0 }"> 
				  ...
				  <tbody>
					  <c:forEach var="ts" items="${timesheet}">
						   <tr>
							      ...
							      <td><a class="btn btn-sm btn-danger" href='/deletetimesheetad/${ts.id}' onclick="return confirm('Are you sure for Delete..?')">Delete</a></td>
		...
		<form method="post" action="/viewtimead" > 
	 		<section class="intro">
	        ...
	        <div class="col-md-3 mb-3 mb-md-0">
                <div id="location" class="form-outline form-white">
                  <input type="email" id="form3" class="form-control form-control-lg" name="email" placeholder="Employee Email"/>
             ...
             <div class="col-md-3 mb-3 mb-md-0">
                <div id="location" class="form-outline form-white">
                  	<input type="date" id="form2"  class="form-control form-control-lg" >
                </div>
             </div>
